...
export default function About(props) {
    ...
    let myStyle = {
        color: props.mode ==='dark'? 'white':'#042f55',
        backgroundColor: props.mode==='dark'?'rgb(35 74 104)':'white',
        border: "2px solid",
        borderColor: props.mode ==='dark'? 'white':'#042f55',
    }

    return (
        <div className='container' style={{color: props.mode ==='dark'? 'white':'#042f55'}}>
            <h1 className='my-3'>Anout Us</h1>
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample" style={myStyle}>
                        <div className="accordion-body" style={myStyle}>
                         TextUtils is a free character counter tool that provides instant character count & word count statistics for a given text. Textutils reports the
